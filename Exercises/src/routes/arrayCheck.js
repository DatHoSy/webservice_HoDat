...
router.get('/fizz-buzz/:numb', arrayCheckController.FizzBuzz);
router.get('/char-at/:index', arrayCheckController.CharAt);
router.get('/change-time', arrayCheckController.ChangeTime);
